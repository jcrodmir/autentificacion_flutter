...
import 'package:teslo_shop/features/products/presentation/widgets/products_card.dart';
...
class _ProductsViewState extends ConsumerState<_ProductsView> {
  ...
  //Para hacer infinite scroll
  final ScrollController scrollController = ScrollController();


  //estado inicial y es donde mandamos llamar a las siguiente página
  @override
  void initState() {
    super.initState();
